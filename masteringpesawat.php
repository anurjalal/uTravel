...
<link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
    <p align="center"><font size="3"><strong>Data Pesawat</strong></font></p>
	<center>
	<a href="add_pesawat.php" id="0" class="btn tambah" style="margin-bottom: 20px;margin-top: 15px;">
		<i class="fa fa-plus"></i> Tambah Pesawat
	</a>
	<br/>
...
<div id="data-pesawat"></div>
</center>
<script src="jquery-1.8.3.min.js"></script>
<script src="js/bootstrap.min.js"></script>
<script src="aplikasipesawat.js"></script>
<?php endblock() ?>