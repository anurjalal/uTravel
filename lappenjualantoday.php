...
echo "<table border=1 style='border-collapse:collapse' width=100%>";
	  echo "<tr style='background-color:#00ffff;-webkit-print-color-adjust:exact'><th width=12.5%><font face=\"courier\" size=2> NO </font></th>
		<th width=12.5%><font face=\"courier\" size=2> NO INVOICE </font></th>
		<th width=12.5%><font face=\"courier\" size=2> NAMA PEMESAN </font></th>
		<th width=12.5%><font face=\"courier\" size=2> TIKET DEWASA </font></th>
		<th width=12.5%><font face=\"courier\" size=2> TIKET ANAK </font></th>
		<th width=12.5%><font face=\"courier\" size=2> HOTEL </font></th>
		<th width=12.5%><font face=\"courier\" size=2> TANGGAL IN </font></th>
		<th width=12.5%><font face=\"courier\" size=2> TANGGAL OUT </font></th>

		<th width=12.5%><font face=\"courier\" size=2> HARGA DEWASA </font></th>
		<th width=12.5%><font face=\"courier\" size=2> HARGA ANAK </font></th>
		<th width=12.5%><font face=\"courier\" size=2> HARGA HOTEL </font></th>
		<th width=12.5%><font face=\"courier\" size=2> HARGA BELI TOTAL </font></th>
		<th width=12.5%><font face=\"courier\" size=2> HARGA JUAL TOTAL </font></th>

		<th width=12.5%><font face=\"courier\" size=2> QTY DEWASA </font></th>
		<th width=12.5%><font face=\"courier\" size=2> QTY ANAK </font></th>
		<th width=12.5%><font face=\"courier\" size=2> QTY KAMAR </font></th>
		<th width=12.5%><font face=\"courier\" size=2> MARGIN PERSEN </font></th>

		<th width=12.5%><font face=\"courier\" size=2> MARGIN TOTAL </font></th>
		<th width=12.5%><font face=\"courier\" size=2> PEMBAYARAN </font></th>
		<th width=12.5%><font face=\"courier\" size=2> TANGGAL DIBAYAR </font></th>
		<th width=12.5%><font face=\"courier\" size=2> KETERANGAN </font></th></tr>";
...
for ($i=0;$i<$myrows1;$i++){
	...
	*/
	...
	if ($datapurchase1['nama_hotel']!='')
	{
	echo "<td width=12.5%><font face=\"Courier\" size=2>".$datapurchase1['nama_hotel']."</font></td>";
	}
	else
	{
	...
	echo "<td width=12.5%><font face=\"Courier\" size=2>".number_format($datapurchase1['hargabeli'],0,',','.')."</font></td>";
		echo "<td width=12.5%><font face=\"Courier\" size=2>".number_format($datapurchase1['hargaanak'],0,',','.')."</font></td>";
	echo "<td width=12.5%><font face=\"Courier\" size=2>".number_format($datapurchase1['hargahotel'],0,',','.')."</font></td>";
	...
	echo "<td width=12.5%><font face=\"Courier\" size=2>".number_format($datapurchase1['jumlahanak'],0,',','.')."</font></td>";
	echo "<td width=12.5%><font face=\"Courier\" size=2>".number_format($datapurchase1['malam']*$datapurchase1['jumlah_kamar'],0,',','.')."</font></td>";
