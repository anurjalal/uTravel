...
<link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
    <p align="center"><font size="3"><strong>Data Supplier</strong></font></p>
	<center> 
	<a href="add_supplier.php" id="0" class="btn tambah" style="margin-bottom: 20px;margin-top: 15px;">
...
<script src="aplikasisupplier.js"></script>
<?php endblock() ?>