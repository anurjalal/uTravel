...
echo "<font face=\"courier\" size=3><b>KAS AWAL";
echo "<table border=1 style='border-collapse: collapse;' width=100%>";
echo "<tr style='background-color:#ccccff; -webkit-print-color-adjust:exact'>
      <th width=20%><font face=\"courier\" size=2> TGL PENCATATAN </font></th>
...
$myquery1="SELECT * FROM kas
           WHERE keterangan in ('Saldo Awal Kas','Saldo Awal Bank')";
...
echo "<table border=1 style='border-collapse: collapse;' width=100%>";
echo "<tr style='background-color:#ccccff; -webkit-print-color-adjust:exact'>
      <th width=20%><font face=\"courier\" size=2> KODE PENJUALAN </font></th>
      <th width=13%><font face=\"courier\" size=2> TGL PENJUALAN </font></th>
