			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="logo-brand">
						<a href="admin.php"><img src="images/utravel.jpg" alt="Undip Maju"></a>
					</div><!-- /.logo-brand -->
					<!-- End Logo brand -->
				...
				<ul class="sidebar-menu">
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a href="masteringbandara.php">Bandara</a></li>
							<li><a href="masteringpesawat.php">Pesawat</a></li>
							<li><a href="masteringstasiun.php">Stasiun</a></li>
							<li><a href="masteringkereta.php">Kereta</a></li>
							<li><a href="masteringhotel.php">Hotel</a></li>
