...
<link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
    <p align="center"><font size="3"><strong>Data Hotel</strong></font></p>
	<center>
	<a href="add_hotel.php" id="0" class="btn tambah" style="margin-bottom: 20px;margin-top: 15px;">
...
<script src="aplikasihotel.js"></script>
<?php endblock() ?>