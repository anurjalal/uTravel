	...
	function setHarga()
		{
						...
						var checkBox = document.getElementById("totalan");
						...
						var total_harga = Number(hargahotel) * Number(malam) * Number (jumlah_kamar);
						if (tgl_out!='')
						{
						var total = (Number(hargabeli) * Number(jumlah) * 2) + (Number(hargaanak)* Number(jumlahanak) * 2) + Number(hargabagasi) + Number(total_harga);
						}
						else
						{
						var total = (Number(hargabeli) * Number(jumlah)) + (Number(hargaanak)* Number(jumlahanak)) + Number(hargabagasi) + Number(total_harga);
						}
						...
						if (tgl_out!='')
						{
						var total = (Number(hargabeli) * Number(jumlah)*2) + (Number(hargaanak)* Number(jumlahanak)*2) + Number(hargabagasi) + Number(hargahotel);
						}
						else
						{
							var total = (Number(hargabeli) * Number(jumlah)) + (Number(hargaanak)* Number(jumlahanak)) + Number(hargabagasi) + Number(hargahotel);
						}
						$("#hargabelitotal").val(Number(total));
						}
...
if(isset($_POST['no_penjualan']))
  {
	...
	$db->execute("INSERT INTO pembelian(no_po,no_penjualan,tgl_po,tgl_jatuh_tempo,hargabeli,hargaanak,hargabagasi,sudah_total,nama_hotel,hargahotel,hargabelitotal,nama_maskapai,id_supplier,nama_supplier,no_invoice,tgl_invoice,username,tgl_transaksi) values ('$no_po','$no_penjualan','$tgl_po','$tgl_jatuh_tempo',$hargabeli,$hargaanak,$hargabagasi,'$totalan','$nama_hotel',$hargahotel,$hargabelitotal,'$nama_maskapai','$id_supplier','$nama_supplier','$no_invoice','$tgl_invoice','$username',NOW())");
    $db->execute("INSERT INTO hutang(no_po,tgl_po,id_supplier,nama_supplier,tgl_jatuh_tempo,jml_hutang,kredit,username,tgl_transaksi) values ('$no_po','$tgl_po','$id_supplier','$nama_supplier','$tgl_jatuh_tempo',$hargabelitotal,$hargabelitotal,'$username',NOW())");
      ...
      {
        $db->execute("INSERT INTO penjualan(no_penjualan,tgl_penjualan,id_customer,nama_customer,tgl_in,tgl_out,tipe,jumlah,jumlahanak,asal,tujuan,hotel,hargaanak,sudah_total,hargahotel,nama_hotel,hargabagasi,malam,jumlah_kamar,jenis_kamar,nama_maskapai,supplier,extra,kelas,hargabeli,marginpersen,hargajual,hargajualtotal,pajak, hrgjualdgnpajak, hargabelitotal,margintotal,tgl_dibayar,statusdibayar,no_po,no_invoice,sistem_bayar,metode_bayar,tgl_invoice,keterangan,username,tgl_transaksi) values ('$no_penjualan','$tgl_penjualan','$id_customer','$nama_customer','$tgl_in','$tgl_out','$tipe','$jumlah','$anak','$asal','$tujuan','$hotel','$hargaanak','$totalan','$hargahotel','$nama_hotel','$hargabagasi','$malam','$jumlah_kamar','$jenis_kamar','$nama_maskapai','$supplier','$extra','$kelas',$hargabeli,$margin,$hargajual,$hargajualtotal,'$denganpajak','$hargadenganpajak','$hargabelitotal','$margintotal',NOW(),'LUNAS','$no_po',$no_invoice,'$sistem_bayar','$metode_bayar','$tgl_invoice_penjualan','$keterangan','$username',NOW())");
      ...
      {
$db->execute("INSERT INTO penjualan(no_penjualan,tgl_penjualan,id_customer,nama_customer,tgl_in,tgl_out,tipe,jumlah,jumlahanak,asal,tujuan,hotel,hargaanak,hargahotel,nama_hotel,malam,jumlah_kamar,jenis_kamar,nama_maskapai,supplier,extra,kelas,hargabeli,marginpersen,hargajual,hargajualtotal,pajak, hrgjualdgnpajak, hargabelitotal,margintotal,tgl_jatuh_tempo,no_po,no_invoice,sistem_bayar,metode_bayar,tgl_invoice,keterangan,username,tgl_transaksi) values ('$no_penjualan','$tgl_penjualan','$id_customer','$nama_customer','$tgl_in','$tgl_out','$tipe','$jumlah','$anak','$asal','$tujuan','$hotel','$hargaanak','$hargahotel','$nama_hotel','$malam','$jumlah_kamar','$jenis_kamar','$nama_maskapai',$supplier','$extra','$kelas',$hargabeli,$margin,$hargajual,$hargajualtotal,'$denganpajak','$hargadenganpajak','$hargabelitotal','$margintotal','$tgl_jatuh_tempo_penjualan','$no_po',$no_invoice,'$sistem_bayar','$metode_bayar','$tgl_invoice_penjualan','$keterangan','$username',NOW())");
...
<form name="penjualan" method="post" action="">
    ...
    <table>
            ...
            <td><div align="left" style="margin-left: 20px"><strong>Dewasa</strong></div></td>
            ...
            <td><div align="left" style="margin-left: 20px"><strong>Anak</strong></div></td>
            ...
            <td><div align="left" style="margin-left: 20px"><strong>Tanggal Out</strong></div></td>
            <td><input style="height: 30px;margin-bottom: 0px" id="tgl_out" class="tgl_out" name="tgl_out" type="text" value="<?php if ($line->tgl_out) {echo date('d-m-Y', strtotime($line->tgl_out));} ?>"></td>


      <td>
        <div align="left" style="margin-left: 20px"><strong>Maskapai/Kereta</strong></div></td>
      ...
      <tr>
      <td><div align="left"><strong>Asal</strong></div></td>
        <td><input style="height: 30px;margin-bottom: 0px" id="asal" class="asal" name="asal" type="text" value="<?php echo $line->asal; ?>"></td>

      <td><div align="left" style="margin-left: 20px"><strong>Tujuan</strong></div></td>
            <td><input style="height: 30px;margin-bottom: 0px" id="tujuan" class="tujuan" name="tujuan" type="text" value="<?php echo $line->tujuan; ?>"></td>
        ...
        <textarea id="txtArea" rows="5" name="keterangan"><?php echo $line->keterangan; ?></textarea>
          ...
          <td>
      <div class="checkbox">
        <label><input style="margin-left: 5px" id="extra" name="extra" type="checkbox"  value="1" <?php if ($line->extra=='Y') {echo 'checked';} else {echo '';}?> >Extra Bagasi</label>
</div>
<div class="checkbox">
<label><input style="margin-left: 5px" id="hotel" name="hotel" type="checkbox"  value="1" <?php if ($line->hotel=='Y') {echo 'checked';} else {echo '';}?> >Hotel</label>
</div>	</td>
      </tr>
<!--
      <tr>
...
-->
      <td><div name="nhotel" id="nhotel" align="left" style="margin-left: 20px;display:none"><strong>Nama Hotel</strong></div></td>

          <td><input type="text" id="nama_hotel" name="nama_hotel" value="<?php echo $line->nama_hotel ?>" onfocus="setHotel(this)" style="display:none;height: 30px;margin-bottom: 0px"/>

        <td>
  <div name="nmalam" id="nmalam" align="left" style="margin-left: 20px;display:none"><strong>Malam</strong></div></td>

  <td><input type="text" id="malam" name="malam" value="<?php echo $line->malam?>" style="display:none;height: 30px;margin-bottom: 0px"/>
      ...
      <td>
        ...
        <tr>
          ...
          <td><input style="height: 30px;margin-bottom: 0px" id="nama_supplier" class="nama_supplier" name="nama_supplier" type="text" onfocus="setSupplier(this)" value="<?php echo $line2->nama_supplier?>"></td>
            ...
            <tr>
              <td><div align="left"><strong>Harga Dewasa</strong></div></td>
              ...
              <td><div align="left" style="margin-left: 20px"><strong>Harga Anak</strong></div></td>
...
<td><div id="nhargahotel" align="left" <?php if ($line->hotel=='Y') {echo 'style="margin-left: 20px"';} else {echo 'style="display:none;margin-left: 20px"';}?>><strong>Harga Hotel</strong></div></td>
              ...
              <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargajual" name="hargajual" value="<?php echo $line->hargajual?>" onkeyup="setHarga()" ></td>
              <td><div align="left" style="margin-left: 20px"><strong>Harga Jual tanpa Pajak</strong></div></td>
              <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="hargajualtotal" name="hargajualtotal" value="<?php echo $line->hargajualtotal?>" onkeyup="setHarga()"></td>
              </tr>
              <tr>
              <td><div align="left"><strong>Margin (%)</strong></div></td>
              <td><input style="height: 30px;margin-bottom: 0px" type="text" id="margin" name="margin" value="<?php echo $line->marginpersen?>" oninput="setHargaReset()" onblur="setHarga()"></td>
              <td><div align="left" style="margin-left: 20px"><strong>Total Margin</strong></div></td>
              <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="margintotal" name="margintotal" value="<?php echo $line->margintotal?>" onkeyup="setHarga()"></td>
              </tr>
          <tr>
          <td><div align="left"><strong>Pajak (%)</strong></div></td>
          <td><input style="height: 30px;margin-bottom: 0px" name="denganpajak" id="denganpajak" type="text" onkeyup="setHarga()" value="<?php echo $line->pajak?>"></td>
          <td><div align="left" style="margin-left: 20px"><strong>Harga Jual dengan Pajak</strong></div></td>
          <td><input readonly style="height: 30px;margin-bottom: 0px" name="hargadenganpajak" id="hargadenganpajak" type="text" value="<?php echo $line->hrgjualdgnpajak?>" onkeyup="setHarga()"></td>
          </tr>
              <tr>
          ...
          <tr>
                    <td><strong>Sistem Bayar</strong></td><td><select style="height: 30px;margin-bottom: 0px" id="sistem_bayar" name="sistem_bayar" onchange="showhidefields(this.value)" required>
                      <option value="">Tidak ada</option>
                      <option value="CASH"<?php if ($line->sistem_bayar=='CASH') {echo "selected";}?>>Cash</option>
                      <option value="TEMPO"<?php if ($line->sistem_bayar=='TEMPO') {echo "selected";}?>>Tempo</option>
                    </select>
                  </td>
                    <td id="pembayaran_label" <?php if ($line->metode_bayar) { echo '';} else {echo 'style="display:none"';}?>><div align="left" style="margin-left: 20px"><strong>Pembayaran</strong></td><td id="pembayaran_isi" <?php if ($line->metode_bayar) { echo '';} else {echo 'style="display:none;"';}?>><select name="metode_bayar">
                      <option value="">Tidak ada</option>
                      <option value=1 <?php if ($line->metode_bayar==1) {echo "selected";}?>>Kas</option>
                      <option value=2 <?php if ($line->metode_bayar==2) {echo "selected";}?>>Bank</option>
                    </select></td>
          <td id="tgl_jatuh_tempo_label" <?php if ($line->tgl_jatuh_tempo!='0000-00-00 00:00:00') { echo '';} else {echo 'style="display:none"';}?>><div align="left" style="margin-left:20px"><strong>Jatuh Tempo Penjualan</strong></div></td>
              <td id="tgl_jatuh_tempo_isi" <?php if ($line->tgl_jatuh_tempo!='0000-00-00 00:00:00') { echo '';} else {echo 'style="display:none"';}?>><input style="height: 30px;margin-bottom: 0px" id="tgl_jatuh_tempo_penjualan" class="tgl_jatuh_tempo_penjualan" name="tgl_jatuh_tempo_penjualan" type="text" value="<?php echo date('d-m-Y',strtotime($line->tgl_jatuh_tempo)) ?>"></td>
          </tr>
			        <table>
			        <tr>
                    <br>
