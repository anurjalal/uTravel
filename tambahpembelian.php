...
function runSetHarga(){
 $("#tipe, #jumlahanak, #jumlah_kamar,#hargahotel, #malam, #hargabeli, #hargabelireturn, #hargaanakreturn, #hargaanak, #hargabagasi, #hargabagasireturn").keyup(function () {
 	setHarga();
		...
		<p align="center">
			<table>
			       ...
			       <tr>
			        ...
			        <td>
			        <select style="height: 30px;margin-bottom: 0px;text-align:right" name="tipe" id="tipe" class="tipe" required onload="runSetHarga()" onclick="runSetHarga()" onkeyup="" ="setHarga()">
				...
				<td><div align="left" id="tglout" name="tglout"><strong>Tanggal Out</strong></div></td>
...
<td><input type="text" id="nama_hotel" name="nama_hotel" value="" onfocus="setHotel(this)" style="height: 30px;margin-bottom: 0px">

<td>
<div name="nmalam" id="nmalam" align="left" style="margin-left: 20px"><strong>Malam</strong></div></td>

<td><input type="text" id="malam" name="malam" value="" style="height: 30px;margin-bottom: 0px"/>
...
<td><input type="text" id="jumlah_kamar" name="jumlah_kamar" value="" style="height: 30px;margin-bottom: 0px"/>
</td>
...
-->
					...
					<tr>
						...
						<td><input style="height: 30px;margin-bottom: 0px" id="nama_supplier" class="nama_supplier" name="nama_supplier" type="text" onfocus="setSupplier(this)"></td>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargabeli" name="hargabeli" value="" onchange="setHarga()"></td>

					<td><div align="left" style="margin-left: 20px" id="nhargaanak"><strong>Harga Anak</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargaanak" name="hargaanak" value="" oninput="setHarga()"></td>
			        ...
			        <td><input <?php if ($line->extra=='Y') {echo 'style="height: 30px;margin-bottom: 0px"';} else {echo 'style="display:none;height: 30px;margin-bottom: 0px"';}?> type="text" id="hargabagasi" name="hargabagasi" value="" onkeyup="setHarga()"></td>
				  ...
				  <label><input id="totalan" name="totalan" type="checkbox" onclick="setHarga()"></label>
				</div>
			</td>
							
			        <tr>
						  <td><div align="left"><strong>Harga Beli Total</strong></div></td>
			        <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="hargabelitotal" name="hargabelitotal" value="" onload="setHarga()"></td>
