...
<?php
	...
	if(!isset($_SESSION['LOGIN_NAME']) || $_SESSION['ID_GROUP'] !='Warehouse'){ // if session variable "username" does not exist.
		...
		<div class="wrapper">
			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="logo-brand">
						<a href="warehouse.php"><img src="images/honda-logo.png" alt="Sinar Rodamas"></a>
					</div><!-- /.logo-brand -->
					<!-- End Logo brand -->
			...
			<div class="sidebar-left sidebar-nicescroller">
				<ul class="sidebar-menu">
					<li><a href="warehouse.php"><i class="fa fa-dashboard icon-sidebar"></i>Dashboard</a></li>
					<li>
						<a href="#">
