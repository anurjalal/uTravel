...
<link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
    <p align="center"><font size="3"><strong>Buku Pesanan</strong></font></p>
	<center>
	<a href="pesanan.php" id="0" class="btn tambah" style="margin-bottom: 20px;margin-top: 15px;">
		<i class="fa fa-plus"></i> Tambah Pencatatan Pesanan
	</a>
	<br/>
...
<script src="aplikasipesanan.js"></script>
<?php endblock() ?>