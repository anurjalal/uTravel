...
<link href="css/bootstrap.min.css" rel="stylesheet" media="screen">
    <p align="center"><font size="3"><strong>Data Bandara</strong></font></p>
	<center>
	<a href="add_bandara.php" id="0" class="btn tambah" style="margin-bottom: 20px;margin-top: 15px;">
...
<div id="data-bandara"></div>
</center>
<script src="jquery-1.8.3.min.js"></script>
<script src="js/bootstrap.min.js"></script>
<script src="aplikasibandara.js"></script>
<?php endblock() ?>