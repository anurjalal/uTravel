...
<?php
  ...
  <label id="semuareturn"><input style="margin-left: 5px" id="return" name="return" type="checkbox" onload="runSetHarga()" onclick="runSetHarga()" value="1" <?php if ($line->kembali=='y') {echo 'checked';} else {echo '';}?>>Pulang Pergi</label>
                ...
                <div class="checkbox">
  <label id="semuaextra"><input style="margin-left:5px" id="extra" name="extra" type="checkbox" onload="setHarga()" onclick="runSetHarga()" value="1" <?php if ($line->extra=='Y') {echo 'checked';} else {echo '';}?> >Extra Bagasi</label>
</div>
</td>
</tr>
<!--
...
<td><div id="nhargahotel" align="left" ><strong>Harga Hotel</strong></div></td>
              ...
              <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" onkeyup="setHarga()" id="hargabelitotal" name="hargabelitotal" value="<?php echo $line2->hargabelitotal?>" ></td>
