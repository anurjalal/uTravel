...
.inside tbody {
    ...
    display: block;
        ...
        <form action="terimapiutang_per_pesanan.php" method ="post">
...
<tbody class="header">
    ...
    <tr>
        ...
        <td><?php echo $data['hrgjualdgnpajak'] ?></td>
        <td><?php echo date('d-m-Y',strtotime($data['tgl_jatuh_tempo'])) ?></td>
        <td><?php if ($data['no_invoice'] == ""){
                echo " <a href= 'create_no_invoice_penjualan.php?no_penjualan=$data[no_penjualan]'>Masukkan Invoice</a>" ;}
		...
		<td><?php if ($data['statusdibayar']!='LUNAS') {
            ?>
            
             <a href="terimapiutang_per_pesanan.php?id=<?php echo $data['no_penjualan']?>" id="<?php echo $data['no_penjualan']?>"> 
                <i><small>BAYAR</small></i>
			 </a>
			 			 
		
		<?php } else if ($data['statusdibayar']=='LUNAS') { ?> 
             <a href="batalkanpenerimaan.php?id=<?php echo $data['no_penjualan']?>" id="<?php echo $data['no_penjualan']?>" onclick="return confirm('ANDA YAKIN AKAN MEMBATALKAN PENERIMAAN INI ... ?')"> 
                <i><small>BATAL</small></i>
                 </a>
		<?php if ($data['no_invoice']!='') {
				 ?>
			 <a href="cetakinvoice.php?id=<?php echo $data['no_invoice']?>" id="<?php echo $data['no_invoice']?>"> 
                | <i><small>CETAK</small></i>
			 </a>				 
        <?php } } ?>
