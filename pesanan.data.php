...
<tbody class="header">
    ...
    <tr>
			...
			<td class="harga"><?php echo number_format($data['jumlahanak'],0,'','.'); ?></td>
		...
		<?php if ($data['no_penjualan']!='' && $data['no_po']!=0 && $statusbayarpembelian != 'LUNAS' && $statusbayarpenjualan != 'LUNAS') {?>
    ...
    <a href="tambahpenjualan.php?id=<?php echo $data['no_penjualan']?>" id="<?php echo $data['no_penjualan']?>" class="ubah" data-toggle="modal">
		...
		<a href="lihatpenjualan.php?id=<?php echo $data['no_penjualan']?>" id="<?php echo $data['no_penjualan']?>" class="ubah" data-toggle="modal">
                <i class="fa fa-edit"><small>Lihat Penjualan</small></i>
        </a>
						<?php } ?>
		</td>
    </tr>
